		...
		<aside id="sidebar_left">
			<div class="user-info">
				<div class="media">
					...
					<div class="media-body">
						<h5 class="media-heading mt5 mbn fw700 cursor">admin<span class="caret ml5"></span></h5>
			...
			<div class="sidebar-menu">
				<ul class="nav sidebar-nav">
					...
					<li>
						<a class="accordion-toggle" href="selectAllUser.action" target="right"> <span class="glyphicons glyphicons-settings"></span><span class="sidebar-title">用户管理</span><span class="caret"></span></a>

					</li>
					
					<li>
						<a class="accordion-toggle" href="selectAllChildren.action" target="right"> <span class="glyphicons glyphicons-user"></span><span class="sidebar-title">幼儿管理</span><span class="caret"></span></a>

					</li>
					<li>
						<a class="accordion-toggle" href="selectAllTeacher.action" target="right"><span class="glyphicons glyphicons-user"></span><span class="sidebar-title">教师管理</span><span class="caret"></span></a>
					</li>

					<li>
						<a class="accordion-toggle" href="selectAllClassinfo.action" target="right"><span class="glyphicons glyphicons-tags"></span><span class="sidebar-title">班级管理</span><span class="caret"></span></a>
					</li>
					<li>
					<!-- 	<a class="accordion-toggle" href="javascript:void(0)" onclick="approvalApple('报名审批',1)" target="right"><span class="glyphicons glyphicons-user"></span><span class="sidebar-title">报名审批</span><span class="caret"></span></a> -->
						<a class="accordion-toggle" href="selectAllApple.action" target="right"><span class="glyphicons glyphicons-user"></span><span class="sidebar-title">报名审批</span><span class="caret"></span></a>
					</li>
				</ul>
			</div>
		</aside>
		<div style="position: absolute;left: 230px;width:88%;">
		<iframe scrolling="yes" frameborder="0" name="right" src="selectAllUser.action" width="100%" height="900"></iframe>
	</div>
		</div>
...
<!-- 	<script type="text/javascript">
		//添加编辑弹出层
		function approvalApple(title, id) {
			$.jq_Panel({
				title: title,
				iframeWidth: 500,
				iframeHeight: 300,
